...
<form method="post" action="{{ route('front.comments.send', ['type' => $type, 'id' => $id]) }}">
    ...
    <div class="skin-btn-wrap">
        <input type="submit" value="Отправить" class="skin-btn skin-btn-reg2 ajax-submit" data-prevent="false" data-msg="true" data-href="{{ route('front.comments.send', ['type' => $type, 'id' => $id]) }}" name="">
    </div>
    </div>
</form>
